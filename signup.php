  ...
  if(isset($_POST['submit'])){
    ...
    if(mysqli_num_rows($duplicate)>0){
      ...
      if($password == $password2){
        $query = "INSERT INTO users VALUES( '', '$name','$username',  '$mobile' ,'$email' ,'$adharnumber', '$adharcard', '$password')";
      ...
      echo"<h3>Enter the valid AdharCard number!</h3>";
    }
    }
  }
?>
          ...
          <div class="login-wrapper m-0">
            ...
            <div class="form-group mb-4">
              ...
              <div class="form-group mb-4">
                ...
                <input type="number" name="adharnumber" placeholder="Enter your Adhar Number" id="adharnumber" class="form-control" >
              </div>
              
              <div class="form-group mb-4">
                <label for="adharnumber">Adhar Card</label>
