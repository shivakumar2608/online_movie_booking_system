...
if(isset($_POST['submit'])){
    ...
    if(mysqli_num_rows($duplicate)>0){
      echo " <alert> Movie already exist </alert>";
        ...
        elseif($movieCategory == "romanticMovie"){
          $query = "INSERT INTO movies VALUES( '', '$title','$cover_img',  '$description' , '$category' ,'$duration', '$date_showing', '$end_showing', '$trailer_yt_link')";
          mysqli_query($conn, $query);
          echo " <alert> Movie uploaded</alert>";
        }
        elseif($movieCategory == "comedyMovie"){
          $query = "INSERT INTO comedy_movies VALUES( '', '$title','$cover_img',  '$description' , '$category' ,'$duration', '$date_showing', '$end_showing', '$trailer_yt_link')";
          mysqli_query($conn, $query);
          echo " <alert> Movie uploaded</alert>";
        }
        elseif($movieCategory == "events"){
          $query = "INSERT INTO events VALUES( '', '$title','$cover_img',  '$description' , '$category' ,'$duration', '$date_showing', '$end_showing', '$trailer_yt_link')";
          mysqli_query($conn, $query);
          echo " <alert> Movie uploaded</alert>";
        }
        ...
        <div class="col-sm-6 login-section-wrapper">
          <div class="login-wrapper m-0">
            ...
            <div class="form-group mb-4">
                ...
                <select name="movieCategory" class="form-select" aria-label="Default select example">
                  <option name="actionMovie" value="actionMovie">Action Movie</option>
                  <option name="romanticMovie" value="romanticMovie">Romantic Movie</option>
                  <option name="comedyMovie" value="comedyMovie">Comedy Movie</option>
                  <option name="events" value="events">Event</option>
                </select>
              </div>
